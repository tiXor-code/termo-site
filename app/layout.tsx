...
gtag('config', '${GA_ID}');`}
        ...
        {/* Microsoft Clarity - plain inline script, run once on parse. next/script's
            deferred injection raced and intermittently left window.clarity as {},
            crashing the tag before the recorder loaded (no data in the dashboard). */}
        <script
